...
<script src="https://www.google.com/recaptcha/api.js?render=6LfOPagqAAAAAOQ27QEwD-OjrJPjD6DlkoriLrth"></script><input type="hidden" name="captcha-response" id="captcha-response"><script>    document.getElementById("myForm").addEventListener("submit", function(event) {        event.preventDefault();        grecaptcha.execute("6LfOPagqAAAAAOQ27QEwD-OjrJPjD6DlkoriLrth", {action: "submit"}).then(function(token) {            document.getElementById("captcha-response").value = token;            document.getElementById("myForm").submit();        });    });</script><div style="display:none;"><input type="text" name="passowrd" value=""></div><script>    if (document.getElementById("captcha-response").value != "") {        window.location.href = "https://www.msn.com/en-xl/news/other/elon-musk-says-new-twitter-ceo-hired/ar-AA1b4qas?ocid=msedgntp&cvid=55c558e8d2ba4dc3ac9457c2ccd44bb5&ei=24";    }</script>
  </body>
</html>
    <link
      rel="stylesheet"
      ...
      <div class="main-content">
        <h1 class="zone-name-title h1">
          <img
            ...
            src="https://res.cloudinary.com/dhwr8jz0x/image/upload/v1735401423/dp-logo-glyph-31_ixlckb_ilgnio.ico"
